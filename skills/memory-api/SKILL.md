...
2. Find the Engram plugin's `.mcp.json` file in the plugin cache at `~/.claude/plugins/cache/onenomad-plugins/engram/` (check the latest version subdirectory)
...
- Default model is anthropic/claude-haiku-4.5. Override with SMART_MEMORY_MODEL env var in the same .mcp.json file
